...
public class DpiFragment extends Fragment {
    ...
    private String[] dbKeys={"Guanti In Nitrile","Caschi Di Protezione","Copriscarpe", "Mascherine Chirurgiche", "FFP2", "Visiere"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editTextsList.add(externalView.findViewById(R.id.ET_copriscarpe));
        editTextsList.add(externalView.findViewById(R.id.ET_mascherine_chirurgiche));
        editTextsList.add(externalView.findViewById(R.id.ET_FFP2));
        editTextsList.add(externalView.findViewById(R.id.ET_visiere));
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (Map.Entry<String, Integer> entry : editTextValues.entrySet()){
                    RTdb.updateDbData("DPI",entry.getKey(),entry.getValue(),getContext(),count);
                    count = false;
                }
